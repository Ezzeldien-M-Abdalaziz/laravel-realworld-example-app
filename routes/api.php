...
Route::middleware(['auth:api'])->group(function () {
    ...
    //revisions
    Route::prefix('articles/{article:id}/revisions')->group(function () {
        Route::get('/', [ArticleRevisionController::class, 'index']);
        Route::get('{revision:id}', [ArticleRevisionController::class, 'show']);
        Route::post('{revision:id}/revert', [ArticleRevisionController::class, 'revert']);
    });
});
